...
public class calendar_read_only_patients extends AppCompatActivity {

    private static String PATIENTS_KEY = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(calendar_read_only_patients.this, 1); // 1 column
        ...
        eventAdapter = new EventAdapter_readOnly(calendar_read_only_patients.this, dataList);
        ...
        if (bundle != null) {
            PATIENTS_KEY = bundle.getString("KEY");
            Log.d("DEBUG", "KEY FOR CALENDAR: " + PATIENTS_KEY);
        }
